...
//  Asteroids
//
//  Created by Bruce Burgess on 9/30/17.
...
class AsteroidsViewController: UIViewController {
    ...
    private func initializedIfNeeded() {
    ...
    private struct Constants {
        ...
        static let normailzedDistanceofShipFromEdge: CGFloat = 0.2
        ...
        static let normalizedAsteroidFieldCenter: [UIInterfaceOrientation:CGPoint] = [
            .portrait : CGPoint(x: 0.5, y: 1.0-Constants.normailzedDistanceofShipFromEdge),
            .portraitUpsideDown : CGPoint(x: 0.5, y: Constants.normailzedDistanceofShipFromEdge),
            .landscapeLeft : CGPoint(x: Constants.normailzedDistanceofShipFromEdge, y: 0.5),
            .landscapeRight : CGPoint(x: 1.0-Constants.normailzedDistanceofShipFromEdge, y: 0.5),
